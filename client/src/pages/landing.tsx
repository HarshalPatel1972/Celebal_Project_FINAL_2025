    ...
    <div className="min-h-screen bg-cinema-gradient">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-spotlight-orange">
                  SPOTLIGHT
                </h1>
        ...
        <div className="relative container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Premium movie bookings with immersive theater experiences,
              real-time seat selection, and seamless payment integration.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Discover the ultimate cinematic experience with our premium
              features designed for movie enthusiasts.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-cinema-black border-cinema-dark">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-300">
                  Book your seats instantly with real-time availability and
            ...
            <Card className="bg-cinema-black border-cinema-dark">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-300">
                  Enjoy luxury seating, premium screens, and immersive theater
                  environments.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-cinema-black border-cinema-dark">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-300">
                  Advanced security measures and contactless booking for your
                  peace of mind.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-20 bg-cinema-gradient">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Get ready for the ultimate movie booking experience. Real-time seat
            selection, secure payments, and premium theater environments await.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-cinema-black">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join thousands of movie enthusiasts who trust Spotlight Now for
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-3 mb-4 md:mb-0">
              ...
              <div>
                <h3 className="text-xl font-bold text-spotlight-orange">
                  SPOTLIGHT
                </h3>
                <p className="text-xs text-spotlight-yellow -mt-1">NOW</p>
              </div>
            ...
            <div className="flex space-x-6 text-sm text-gray-400">
              <a
                href="#"
                className="hover:text-spotlight-orange transition-colors"
              >
                Privacy Policy
              </a>
              <a
